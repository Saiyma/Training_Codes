...
try:
    while True:
        ...
        if soil_dry:  # Soil is dry
            ...
            display.lcd_display_string("Soil Dry", 1)
            display.lcd_display_string("Turn ON Pump", 2)
            ...
            display.lcd_display_string("Soil Wet", 1)
            display.lcd_display_string("Turn OFF Pump", 2)
